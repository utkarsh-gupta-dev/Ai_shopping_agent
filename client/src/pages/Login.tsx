  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4 py-12">
      ...
      <Card className="w-full max-w-md p-8" hover={false}>
        ...
        <p className="mt-2 text-sm text-ink-muted">Sign in to your SmartShopping workspace.</p>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-2xl border border-white/10 bg-black/30 px-4 py-3 text-sm text-ink outline-none ring-accent/0 transition focus:border-accent/40 focus:ring-2 focus:ring-accent/20"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-2xl border border-white/10 bg-black/30 px-4 py-3 pr-12 text-sm text-ink outline-none ring-accent/0 transition focus:border-accent/40 focus:ring-2 focus:ring-accent/20"
                placeholder="••••••••"
              />
              <button
                type="button"
        ...
        <p className="mt-6 text-center text-sm text-ink-muted">
          No account?{" "}
          <Link to="/signup" className="font-medium text-accent-muted hover:text-accent">
            Create one
          </Link>
        </p>
      </Card>
